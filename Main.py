...
shoot_fx.set_volume(100)
grenades_fx = pygame.mixer.Sound('audio/grenade.wav')
grenades_fx.set_volume(100)
...
#Tools
#Sound Engineered: Chiptone SFB Fames & Google Chrome Music Lab
#Assets: Aseprite, Reference Pictures

#Link Youtube/Referensi
#Youtube Asset & Audio
#https://musiclab.chromeexperiments.com/Song-Maker/song/6739785888038912 - Song Audio that We Created
#https://www.youtube.com/watch?v=9L-GMmooT0A&ab_channel=InUnisonMusicLessons
#https://www.youtube.com/watch?v=8gufPxOTYOw&ab_channel=GQAudio
#https://www.youtube.com/watch?v=tFsETEP01k8&t=671s&ab_channel=Saultoons